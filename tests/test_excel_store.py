...
from excel_store import ExcelAnswerStore, HEADERS, SHEET_NAME
...
def test_call_result_service_saves_xlsx_with_openpyxl(tmp_path):
    ...
    CallResultService(AnswerExtractor(), ExcelAnswerStore(workbook_path)).finalize(session, "completed")
